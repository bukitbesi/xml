...
- Site JS rewritten as a single vanilla-JS runtime (`tbb-runtime-v221`) — no jQuery or other DOM library dependency; verified zero jQuery references in the shipped template and scripts (jQuery was previously removed from this codebase in #22).
